...
/**
 * Created by Animesh on 4/12/17.
 */
public class RddTry {

    public static void main(String[] args) {

        SparkSession spkSess = SparkSession.builder().appName("RDD-Basic")
                .master("local[4]")
                .getOrCreate();

        JavaSparkContext sc = new JavaSparkContext(spkSess.sparkContext());
